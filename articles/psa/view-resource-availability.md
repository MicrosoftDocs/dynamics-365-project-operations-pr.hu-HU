...
ms.locfileid: "5143876"
---
# <a name="view-resource-availability-project-service"></a>Erőforrás-elérhetőség megtekintése (Project Service)
...
> 
>  Újabb verzió használata esetén az erőforrások rendelkezésre állásához lásd: [Erőforrások ütemezése egy projekthez (Project Service Automation)](../psa/schedule-resources-project.md).  

1. Lépjen a **Project Service > Erőforrás-elérhetőség** pontba.  
