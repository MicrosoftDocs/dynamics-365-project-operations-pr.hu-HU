...
---
# <a name="estimate-a-projectbased-contract-line"></a>Projektalapú szerződéssor becslése
...
## <a name="create-an-estimate-directly-on-a-projectbased-contract-line"></a>Becslés létrehozása közvetlenül egy projektalapú szerződéssoron
...
| **Erőforrás-kezelő vállalat** | **Gyorslétrehozás** | Az az erőforrást biztosító vállalat vagy jogi személy, amely vállalja a költséget, és biztosítja az erőforrást, amin a munkavégzés történik. | Ez a mező alapértelmezés szerint a kapcsolódó szerződéssor részleteit tartalmazza az automatikusan létrehozott költségekhez. Ez a mező az önköltségi ár beolvasása esetén is használatos. |
