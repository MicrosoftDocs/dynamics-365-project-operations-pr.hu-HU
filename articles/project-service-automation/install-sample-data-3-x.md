...
4. Ha nem használ Spencer Low felhasználót **spencerl** felhasználónévvel, egy további fájlt is frissítenie kell. Nyissa meg a **DemoDataPreImportConfig.xml** fájlt, és keresse meg a **userstocreateandconfigure** címkét. Frissítse a **\<login\>** címkét a Spencer Low felhasználó felhasználónevével. További részleteket a lenti [Műszaki megjegyzések](#technical-notes) rész tartalmaz.
...
4. Ha a „Spencer Low” teljes nevű felhasználónak más a felhasználói azonosítója, mint a **„spencerl”**, frissítenie kell a kiegészítő fájlt. Nyissa meg a **DemoDataPreImportConfig.xml** fájlt, és keresse meg a **userstocreateandconfigure** címkét. Frissítse a **\<bejelentkezés\>** címkét a loginId-val (kis-és nagybetűk megkülönböztetésével). 
...
- **\<RequiredSolutions\>** előfeltételt jelentő megoldás-összetevőket és azok verziószámát adja meg.

- **\<InstallSampleData\>** azt vezérli, hogy a kész mintaadatok az alkalmazásokhoz települjenek-e.
