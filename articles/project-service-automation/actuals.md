...
## <a name="using-journals-to-record-costs"></a>Naplók használata a költségek rögzítésére

A PSA-ban a naplók segítségével rögzítheti a költséget vagy bevételt az anyag-, díj-, idő-, költség- vagy adózási tranzakciók osztályaiban. A napló fejlécet, sorokat és egy **Megerősítés** műveletet tartalmaz. Az alábbi helyzetekben érdemes naplót használni:
